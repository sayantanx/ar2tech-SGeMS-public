 ...
 */ 
class FILTERS_DECL Gslib_infilter_dialog : public QDialog, public Ui::ImportWizard { 
...
//TL modified
class FILTERS_DECL Gslib_input_mgrid_dialog : public QWidget, public Ui::GslibMaskedImport
{
	Q_OBJECT
public:
 ...
 */ 
class FILTERS_DECL Gslib_input_grid_dialog : public QWidget, public Ui::GslibGridImport { 
 ...
 */ 
class FILTERS_DECL Gslib_input_pointset_dialog : public QWidget, public Ui::GslibPointsetImport { 
Q_OBJECT
