...
Delete_properties_dialog( GsTL_project* proj, QWidget* parent, const char* name )
  ...
  choice_list_ = new MultiPropertySelector( properties_selector_box_);

  QVBoxLayout * v1 = new QVBoxLayout();
  
  properties_selector_box_->setLayout(v1);
  properties_selector_box_->layout()->addWidget(choice_list_);
...
QStringList Delete_properties_dialog::selected_items() {
  QStringList list;
