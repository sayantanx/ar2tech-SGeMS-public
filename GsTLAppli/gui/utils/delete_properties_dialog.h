...
class GUI_DECL Delete_properties_dialog : public QDialog, public Ui::Delete_properties_dialog_base {

  Q_OBJECT

public:
  Delete_properties_dialog( GsTL_project* proj,QWidget* parent = 0, const char* name = 0 );
