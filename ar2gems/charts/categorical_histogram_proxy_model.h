...
//    virtual QModelIndex	mapToSource ( const QModelIndex & proxyIndex ) const;
    ...
    bool insert_row(Grid_categorical_property* prop, GsTLGridWeightProperty* weights, QColor color = QColor());
...
private :
 ...
 // std::map<GsTL_object_item*,Categorical_histogram_item*> lookup_items_; 
  ...
  bool is_item_exist(Grid_categorical_property* prop, GsTLGridWeightProperty* weights);
