...
class GUI_DECL Data_analysis_gui : public QWidget, public Ui::Data_analysis_gui_base {
...
public slots:
  ...
  //TL modified
  virtual void refresh_plot( QwtPlotCurve * pcurve, std::pair<double*,double*>, int );
...
protected:
  QwtPlot* plot_;
  QwtPlotCurve * curve_id_;
  QwtPlotGrid * curve_grid_;
