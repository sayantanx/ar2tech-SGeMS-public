...
class First_scr : public QWidget, public Ui::First_scr_base {
...
inline std::string First_scr::grid_name() const {
  ...
  return  std::string(qstring2string(grid_->currentText()));
}
...
inline std::string First_scr::head_property() const {
  ...
  return  std::string( qstring2string(head_prop_->currentText()) );
}
...
inline std::string First_scr::tail_property() const {
  ...
  return  std::string( qstring2string(tail_prop_->currentText()) );
}
