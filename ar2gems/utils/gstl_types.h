...
typedef bool GsTLBool; 
typedef short GsTLShort; 
typedef int GsTLInt; 
typedef long GsTLLong; 
typedef unsigned short GsTLUShort; 
typedef unsigned int GsTLUInt; 
typedef unsigned long GsTLULong; 
