...
class Kriging_constraints {
 private:
  ...
  typedef Kriging_constraints_impl<N,G,W,M> BaseClass;
  typedef Kriging_constraints<N,G,W,M> Self;
 ...
 public:
  ...
  inline double kriging_variance_contrib( const Geovalue& center,
...
class Kriging_constraints_impl {
 ...
 typedef WeightsVector W;
 typedef MatrixLibrary M;
 typedef Kriging_constraints_impl<N,G,W,M> Self;
 typedef typename WeightsVector::iterator Iterator_;
 ...
 public:
  ...
  virtual double kriging_variance_contrib( const Geovalue& center,
                                           Iterator_ weights_begin,
...
class SKConstraints_impl : public Kriging_constraints_impl<Neighborhood_,
 ...
 public:
  ...
  virtual BaseClass* clone() const {
    return new SKConstraints_impl<N,G,W,M>;
  }
...
class OKConstraints_impl : public Kriging_constraints_impl<Neighborhood_,
 ...
 public:
  ...
  virtual BaseClass* clone() const {
    return new OKConstraints_impl<N,G,W,M>;
  }
...
class KTConstraints_impl : public Kriging_constraints_impl<Neighborhood_,
 ...
 private:
  ...
  typedef Kriging_constraints_impl<N,G,W,ML> BaseClass;
 ...
 public:
  ...
  virtual BaseClass* clone() const {
    return new KTConstraints_impl<MF,N,G,W,ML>( mean_functions_ );
  }
